import { b as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, a as renderTemplate, g as defineScriptVars, r as renderComponent, e as renderSlot, f as renderScript, F as Fragment } from './astro/server_BJOxqC5a.mjs';
import 'piccolore';
import 'clsx';
import { c as cn } from './class-merge_ZZ4CtDft.mjs';
import { a as $$Icon, h as getFormattedDate, i as $$FormattedDate, $ as $$Button } from './Svg_pSXNt16c.mjs';
/* empty css                        */
import { c as config } from './_virtual_config_Cw6RfqEu.mjs';
import { a as $$QRCode } from './MediumZoom_BI0WmpR-.mjs';
import { Image as $$ResponsiveImage } from './_astro_assets_DaNIag9H.mjs';
import { r as renderEntry } from './_astro_content_BeGRmQpa.mjs';
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/ArticleBottom.astro", void 0);
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/BackToTop.astro", void 0);
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/Paginator.astro", void 0);
...
const $$PostPreview = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ) ?? "") + " astro-yh2ne4rs", "class")}> ${data.description} </p> <div class="flex items-center gap-2 py-1.5 text-sm italic leading-4 text-muted-foreground sm:py-3 astro-yh2ne4rs">  <span class="flex items-center gap-1 astro-yh2ne4rs"> ${renderComponent($$result3, "Icon", $$Icon, { "name": "time", "class": "size-4 astro-yh2ne4rs" })} ${remarkPluginFrontmatter.minutesRead} </span>  ${data.language && renderTemplate`<span class="flex items-center gap-1 astro-yh2ne4rs"> ${renderComponent($$result3, "Icon", $$Icon, { "name": "earth", "class": "size-4 astro-yh2ne4rs" })} ${data.language} </span>`} </div> ` })}`}` })} </a> <!-- tags --> ${detailed && data.tags && renderTemplate`<ul class="tag-list mt-1 flex flex-wrap gap-2 astro-yh2ne4rs"> ${data.tags.map((tag) => renderTemplate`<li class="astro-yh2ne4rs"> ${renderComponent($$result, "Button", $$Button, { "title": tag, "href": `/tags/${tag}`, "variant": "pill", "class": "astro-yh2ne4rs" })} </li>`)} </ul>`} </li> `;
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/PostPreview.astro", void 0);
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/TOCHeading.astro", void 0);
...
const $$TOC = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "toc-heading", "toc-heading", { "class": (className ?? "") + " astro-mmcgqrmu", ...props }, { "default": () => renderTemplate` ${maybeRenderHead()}<h2 class="font-semibold astro-mmcgqrmu">TABLE OF CONTENTS</h2> <ul class="mt-4 text-card-foreground astro-mmcgqrmu"> ${toc.map((heading) => renderTemplate`${renderComponent($$result, "TOCHeading", $$TOCHeading, { "heading": heading, "class": "astro-mmcgqrmu" })}`)} </ul> ` })} ${renderScript($$result, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/TOC.astro?astro&type=script&index=0&lang.ts")} `;
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/TOC.astro", void 0);

const $$PFSearch = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "site-search", "site-search", { "class": "astro-574sfdxb" }, { "default": () => renderTemplate` ${maybeRenderHead()}<aside class="form my-4 astro-574sfdxb"> ${renderTemplate`<div id="site-search" class="astro-574sfdxb"></div>`} </aside> ` })} ${renderScript($$result, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/PFSearch.astro?astro&type=script&index=0&lang.ts")} `;
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/pages/PFSearch.astro", void 0);

export { $$PostPreview as $, $$TOC as a, $$Hero as b, $$Copyright as c, $$ArticleBottom as d, $$Paginator as e, $$BackToTop as f, $$PFSearch as g };
