...
import { c as $$Quote, b as $$GithubCard, d as $$LinkPreview, a as $$QRCode } from './MediumZoom_BI0WmpR-.mjs';
import 'clsx';
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(Fragment$1, {
      ...
      children: [createVNode($$Quote, {}), createVNode(Fragment$1, {
        slot: "desc",
      ...
      width: "80%",
      children: [createVNode($$LinkPreview, {
...
const file = "/Users/rogermurillo/.gemini/antigravity/scratch/src/content/docs/integrations/advanced.mdx";
...
Content.moduleId = "/Users/rogermurillo/.gemini/antigravity/scratch/src/content/docs/integrations/advanced.mdx";
