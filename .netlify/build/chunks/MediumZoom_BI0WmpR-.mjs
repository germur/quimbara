import { b as createAstro, c as createComponent, r as renderComponent, f as renderScript, a as renderTemplate, m as maybeRenderHead, d as addAttribute, g as defineScriptVars, s as spreadAttributes } from './astro/server_BJOxqC5a.mjs';
import 'piccolore';
import { c as cn } from './class-merge_ZZ4CtDft.mjs';
import { a as $$Icon } from './Svg_pSXNt16c.mjs';
/* empty css                                                                  */
import { Image as $$ResponsiveImage } from './_astro_assets_DaNIag9H.mjs';
...
const $$GithubCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "github-card", "github-card", { "class": "not-prose loading astro-fkh43kdv", "data-repo": repo }, { "default": () => renderTemplate` ${maybeRenderHead()}<a${addAttribute(`https://github.com/${repo}`, "href")} target="_blank" class="group block flex flex-col gap-y-2 rounded-xl border px-4 py-3 transition-colors hover:bg-muted hover:text-muted-foreground sm:px-5 sm:py-4 astro-fkh43kdv"> <div class="flex items-center justify-between gap-x-2 astro-fkh43kdv"> <div class="flex min-w-0 flex-1 items-center gap-x-2 text-foreground group-hover:text-primary astro-fkh43kdv"> <div id="gh-avatar" class="load-block me-2 size-7 flex-shrink-0 bg-cover sm:size-8 astro-fkh43kdv" style="border-radius:999px"></div> <div class="min-w-0 flex-1 astro-fkh43kdv"> <div class="flex items-center gap-x-1 max-sm:flex-wrap astro-fkh43kdv"> <span class="truncate text-base transition-colors sm:text-lg astro-fkh43kdv">${owner}</span> <span class="text-muted-foreground max-sm:hidden astro-fkh43kdv">/</span> <span class="truncate text-base font-bold transition-colors sm:text-lg max-sm:w-full astro-fkh43kdv">${repoName}</span> </div> </div> </div> <div class="flex-shrink-0 rounded-full bg-primary-foreground p-1 astro-fkh43kdv"> ${renderComponent($$result, "Icon", $$Icon, { "name": "github", "class": "astro-fkh43kdv" })} </div> </div> <p id="gh-description" class="load-block text-sm sm:text-base astro-fkh43kdv">Waiting for api.github.com...</p> <div class="flex items-center justify-between gap-x-2 astro-fkh43kdv"> <div class="load-block flex flex-wrap items-center gap-x-3 gap-y-1 sm:gap-x-5 astro-fkh43kdv"> <div class="flex items-center gap-x-1.5 sm:gap-x-2 astro-fkh43kdv">  <!-- prettier-ignore --> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="sm:w-[22px] sm:h-[22px] astro-fkh43kdv"><g fill="none" fill-rule="evenodd" class="astro-fkh43kdv"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" class="astro-fkh43kdv"></path><path fill="currentColor" d="M10.92 2.868a1.25 1.25 0 0 1 2.16 0l2.795 4.798l5.428 1.176a1.25 1.25 0 0 1 .667 2.054l-3.7 4.141l.56 5.525a1.25 1.25 0 0 1-1.748 1.27L12 19.592l-5.082 2.24a1.25 1.25 0 0 1-1.748-1.27l.56-5.525l-3.7-4.14a1.25 1.25 0 0 1 .667-2.055l5.428-1.176zM12 4.987L9.687 8.959a1.25 1.25 0 0 1-.816.592l-4.492.973l3.062 3.427c.234.262.347.61.312.959l-.463 4.573l4.206-1.854a1.25 1.25 0 0 1 1.008 0l4.206 1.854l-.463-4.573a1.25 1.25 0 0 1 .311-.959l3.063-3.427l-4.492-.973a1.25 1.25 0 0 1-.816-.592z" class="astro-fkh43kdv"></path></g></svg> <span id="gh-stars" class="text-sm leading-tight sm:text-base astro-fkh43kdv">???</span> </div> <div class="flex items-center gap-x-1.5 sm:gap-x-2 astro-fkh43kdv">  <!-- prettier-ignore --> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="sm:w-[22px] sm:h-[22px] astro-fkh43kdv"><g fill="none" class="astro-fkh43kdv"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" class="astro-fkh43kdv"></path><path fill="currentColor" d="M18 3a3 3 0 0 1 1 5.83V9a4 4 0 0 1-4 4H9a2 2 0 0 0-2 2v.17a3.001 3.001 0 1 1-2 0V8.83a3.001 3.001 0 1 1 2 0v2.705A4 4 0 0 1 9 11h6a2 2 0 0 0 2-2v-.17A3.001 3.001 0 0 1 18 3M6 17a1 1 0 1 0 0 2a1 1 0 0 0 0-2M6 5a1 1 0 1 0 0 2a1 1 0 0 0 0-2m12 0a1 1 0 1 0 0 2a1 1 0 0 0 0-2" class="astro-fkh43kdv"></path></g></svg> <span id="gh-forks" class="text-sm leading-tight sm:text-base astro-fkh43kdv">???</span> </div> <div class="flex items-center gap-x-1.5 sm:gap-x-2 astro-fkh43kdv">  <!-- prettier-ignore --> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="sm:w-[22px] sm:h-[22px] astro-fkh43kdv"><g fill="none" fill-rule="evenodd" class="astro-fkh43kdv"><path d="m12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035q-.016-.005-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427q-.004-.016-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093q.019.005.029-.008l.004-.014l-.034-.614q-.005-.018-.02-.022m-.715.002a.02.02 0 0 0-.027.006l-.006.014l-.034.614q.001.018.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z" class="astro-fkh43kdv"></path><path fill="currentColor" d="M12 3a1 1 0 0 1 1 1v1h.764a2 2 0 0 1 .894.211L16.236 6H20a1 1 0 1 1 0 2h-.382l2.276 4.553c.07.139.106.292.106.447a4 4 0 0 1-8 0c0-.155.036-.308.106-.447L16.382 8h-.146a2 2 0 0 1-.894-.211L13.764 7H13v12h3a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2h3V7h-.764l-1.578.789A2 2 0 0 1 7.764 8h-.146l2.276 4.553A1 1 0 0 1 10 13a4 4 0 0 1-8 0a1 1 0 0 1 .106-.447L4.382 8H4a1 1 0 0 1 0-2h3.764l1.578-.789A2 2 0 0 1 10.236 5H11V4a1 1 0 0 1 1-1M6 9.236l-1.989 3.977a2 2 0 0 0 3.978 0zm12 0l-1.989 3.977a2 2 0 0 0 3.955.157l.023-.156z" class="astro-fkh43kdv"></path></g></svg> <span id="gh-license" class="text-sm leading-tight sm:text-base astro-fkh43kdv">???</span> </div> </div> <span id="gh-language" class="load-block text-sm leading-tight sm:text-base astro-fkh43kdv">?????</span> </div> </a> ` })}  ${renderScript($$result, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/advanced/GithubCard.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/advanced/GithubCard.astro", void 0);
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/advanced/QRCode.astro", void 0);
...
}, "/Users/rogermurillo/.gemini/antigravity/scratch/node_modules/astro-pure/components/advanced/MediumZoom.astro", void 0);

export { $$MediumZoom as $, $$QRCode as a, $$GithubCard as b, $$Quote as c, $$LinkPreview as d };
